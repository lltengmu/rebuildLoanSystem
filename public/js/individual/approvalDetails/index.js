...
/***/ "./resources/js/individual/approvalDetails/form.ts":
/*!*********************************************************!*\
  !*** ./resources/js/individual/approvalDetails/form.ts ***!
  \*********************************************************/
...
var IndividualApprolvalDetails = /** @class */function () {
  function IndividualApprolvalDetails() {
            ...
            switch (_a.label) {
              case 0:
                ...
                return [4 /*yield*/, (0,_utils__WEBPACK_IMPORTED_MODULE_1__.ajax)({
                  url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/approvalManagment/edit/".concat(id)),
                  method: "post",
                  headers: {
                    "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
                  },
                  data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#editCase").serializeArray()
                })];
              case 1:
                res = _a.sent();
                if (res.errorsObject && !res.success) jquery__WEBPACK_IMPORTED_MODULE_0___default()("#editCase").validate().showErrors(res.errorsObject);
  ...
  return IndividualApprolvalDetails;
}();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndividualApprolvalDetails);
...
"use strict";
/*!**********************************************************!*\
  !*** ./resources/js/individual/approvalDetails/index.ts ***!
  \**********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form */ "./resources/js/individual/approvalDetails/form.ts");

...
"use strict";
/*!*************************************************************!*\
  !*** ./resources/js/individual/loanTemplateDetail/index.ts ***!
  \*************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _plugins_notification__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../plugins/notification */ "./resources/js/plugins/notification/index.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils */ "./resources/js/utils/index.ts");


var LoanTemplateDetail = /** @class */function () {
  function LoanTemplateDetail() {
    this.formData = new FormData();
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFunction)(this.opration());
    this.register();
    this.registerUpload();
  }
  LoanTemplateDetail.prototype.register = function () {
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#edit-loan-template", function (form, e) {
      e.preventDefault();
      var formData = new FormData();
      var id = $(form).attr("loan-template-id");
      var uploadField = document.querySelector("#edit-loan-template input[type=\"file\"]");
      var file = uploadField.files[0];
      formData.append("file", file);
      $("#edit-loan-template").serializeArray().forEach(function (item) {
        formData.append(item["name"], item["value"]);
      });
      $.ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/templateManagment/edit/".concat(id)),
        method: "post",
        data: formData,
        headers: {
        ...
        success: function success(res) {
          if (res.status == "success") {
            (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_0__["default"])(res.message);
          }
        },
        error: function error(_error) {
          if (_error.status == 422) {
            var errorMessages = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors);
            if (Object.keys(errorMessages).includes("file")) {
              _plugins_notification__WEBPACK_IMPORTED_MODULE_0__.customAlert.error(errorMessages["file"]);
            }
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#edit-loan-template", errorMessages);
          }
        }
      });
    });
  };
  LoanTemplateDetail.prototype.opration = function () {
    return {
      _uploadImage: function _uploadImage() {
        return $("#edit-loan-template input[type=\"file\"]").click();
      }
    };
  };
  //实现上传图片预览
  LoanTemplateDetail.prototype.registerUpload = function () {
    //注册事件
    var uploadField = document.querySelector("#edit-loan-template input[type=\"file\"]");
    uploadField.addEventListener("change", function (event) {
      ...
      reader.onload = function (e) {
        ...
        $("#image-container").html(function (index, old) {
          return "<img class=\"image\" src=\"".concat(imageUrl, "\" alt=\"Card image cap\">");
        });
      };
      reader.readAsDataURL(file);
    });
  };
  return LoanTemplateDetail;
}();
window.onload = function () {
  return new LoanTemplateDetail();
};
})();

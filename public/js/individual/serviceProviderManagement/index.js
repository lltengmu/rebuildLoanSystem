...
var DataTables = /** @class */function () {
  ...
  DataTables.prototype.registerDataTable = function () {
    this.tableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#serviceProviderTable").DataTable({
      ...
      columnDefs: [{
        ...
        render: function render(data, type, row, meta) {
          var id = row.id;
          return "\n                            <div class=\"opration\">\n                                <button type=\"button\" class=\"btn btn-outline-info\" onclick=\"_view('".concat(id, "')\">\u67E5\u770B</button>\n                                <button type=\"button\" class=\"btn btn-outline-danger\" data-toggle=\"modal\" data-target=\".delete-modal\" onclick=\"_del('").concat(id, "')\">\u5220\u9664</button>\n                            </div>\n                        ");
        }
      }]
    });
  };
   ...
   */
  DataTables.prototype.registerOpration = function () {
    var _this = this;
    var exits = false;
    ...
    Object.entries(window).forEach(function (_a) {
      var key = _a[0],
        value = _a[1];
      if (Object.keys(_this.opration()).includes(key)) exits = true;
    });
    //冲突则抛出异常
    if (exits) throw new ReferenceError("自定义函数与window对象内置函数或属性冲突");
    //否则注册函数,让按钮具备点击事件
    else Object.entries(this.opration()).forEach(function (_a) {
      var key = _a[0],
        value = _a[1];
   ...
   */
  DataTables.prototype.opration = function () {
    var _this = this;
    return {
      //查看详情
      ...
      //修改状态事件处理函数
      _handleStatus: function _handleStatus(id) {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                //开启加载动画
                _utils__WEBPACK_IMPORTED_MODULE_1__.loading.open();
                value = document.querySelector("#status-".concat(id)).value;
                //发送请求
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                  ...
                  (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(message);
                }, function (error) {
                  _utils__WEBPACK_IMPORTED_MODULE_1__.loading.close();
                  console.log(error);
                })];
   ...
   * delete case
   */
  DataTables.prototype.confirmDelete = function (id) {
  ...
  DataTables.prototype.registerFormValidate = function () {
    var _this = this;
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#individual-create-sp", function (form, event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/serviceProviderManagement/add-sp"),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
        },
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#individual-create-sp").serializeArray(),
        success: function success(res) {
          if (res.status == "success") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#create-sp #cancel-modal").click();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#individual-create-sp").find("input").val("");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#individual-create-sp").find("select").val("0");
            _this.tableInstance.ajax.reload();
        ...
        error: function error(_error3) {
          if (_error3.status == 422) {
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#individual-create-sp", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error3.responseJSON.errors));
          }
        }
      });
    });
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#sp-details", function (form, event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/serviceProviderManagement/edit-sp/".concat(globalThis["sp_id"])),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
        },
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sp-details").serializeArray(),
        success: function success(res) {
          if (res.status == "success") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#drawer #cancel").click();
            _this.tableInstance.ajax.reload();
            (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(res.message);
          }
        },
        error: function error(_error4) {
          if (_error4.status == 422) {
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#sp-details", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error4.responseJSON.errors));
          }
        }
      });
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DataTables);
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./node_modules/animate.css/animate.css":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./node_modules/animate.css/animate.css ***!
  \********************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_animate_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!../postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./animate.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./node_modules/animate.css/animate.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_animate_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_animate_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});

...
/***/ "./resources/js/individual/clientsManagment/dataTable.ts":
/*!***************************************************************!*\
  !*** ./resources/js/individual/clientsManagment/dataTable.ts ***!
  \***************************************************************/
...
var ClientsManagmentDataTable = /** @class */function () {
  function ClientsManagmentDataTable() {
    this.registerDataTable();
    this.registerOpration();
  }
  ClientsManagmentDataTable.prototype.registerDataTable = function () {
    this.tableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#clientsTable").DataTable({
      autoWidth: true,
      order: [0, "desc"],
      ajax: {
   ...
   */
  ClientsManagmentDataTable.prototype.registerOpration = function () {
    var _this = this;
    var exits = false;
   ...
   */
  ClientsManagmentDataTable.prototype.opration = function () {
    var _this = this;
    return {
      //导出excel
   ...
   * delete case
   */
  ClientsManagmentDataTable.prototype.confirmDelete = function (id) {
  ...
  return ClientsManagmentDataTable;
}();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ClientsManagmentDataTable);

/***/ }),

/***/ "./resources/js/individual/clientsManagment/formSubmit.ts":
/*!****************************************************************!*\
  !*** ./resources/js/individual/clientsManagment/formSubmit.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var FormSubmit = /** @class */function () {
  function FormSubmit(dataTableInstance) {
    this.dataTableInstance = dataTableInstance;
    this.registerFormSubmit();
  }
  FormSubmit.prototype.registerFormSubmit = function () {
    var _this = this;
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#IndividualCreateClient", function (form, event) {
      event.preventDefault();
      console.log(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#IndividualCreateClient").serializeArray());
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/clientsManagment/add-client"),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
        },
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#IndividualCreateClient").serializeArray(),
        success: function success(res) {
          if (res.status == "success") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#IndividualCreatedClient #cancel").click();
            _this.dataTableInstance.ajax.reload();
            (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(res.message);
          }
        },
        error: function error(_error) {
          if (_error.status == 422) {
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#IndividualCreateClient", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors));
          }
        }
      });
    });
...
"use strict";
/*!***********************************************************!*\
  !*** ./resources/js/individual/clientsManagment/index.ts ***!
  \***********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dataTable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataTable */ "./resources/js/individual/clientsManagment/dataTable.ts");
/* harmony import */ var _formSubmit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formSubmit */ "./resources/js/individual/clientsManagment/formSubmit.ts");


window.onload = function () {
  var dataTableMana = new _dataTable__WEBPACK_IMPORTED_MODULE_0__["default"]();
  new _formSubmit__WEBPACK_IMPORTED_MODULE_1__["default"](dataTableMana.tableInstance);
};
})();

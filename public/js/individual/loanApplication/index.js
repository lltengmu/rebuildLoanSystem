  ...
  LoanApplicationDataTable.prototype.opration = function () {
    ...
    return {
      _export: function _export(id) {
        return console.log("\u5230\u5904excel:id->".concat(id));
      },
      ...
      _del: function _del(id) {
        return console.log("\u5BFC\u51FA\uFF1Aid->".concat(id));
      },

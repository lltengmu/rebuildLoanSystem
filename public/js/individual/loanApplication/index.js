...
var LoanApplicationDataTable = /** @class */function () {
  ...
  LoanApplicationDataTable.prototype.registerDataTable = function () {
    this.tableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#example").DataTable({
      autoWidth: true,
      order: [0, "desc"],
      ajax: {
      ...
      columnDefs: [{
        ...
        width: "25%",
        render: function render(data, type, row, meta) {
          return "\n                            <div class=\"opration\">\n                                <button type=\"button\" class=\"btn btn-outline-primary\" onclick=\"_export(".concat(row.id, ")\">\u532F\u51FAxlsx</button>\n                                <button type=\"button\" class=\"btn btn-outline-info\" onclick=\"_view(").concat(row.id, ")\">\u67E5\u770B</button>\n                                <button type=\"button\" class=\"btn btn-outline-secondary\" onclick=\"_viewFile(").concat(row.id, ")\">\u6587\u4EF6\u67E5\u770B</button>\n                                <button type=\"button\" class=\"btn btn-outline-danger\" onclick=\"_del(").concat(row, ")\">\u5220\u9664</button>\n                            </div>\n                        ");
        }
      }]
    });
  };
  ...
  LoanApplicationDataTable.prototype.opration = function () {
    ...
    return {
      ...
      _view: function _view(id) {
        return console.log("\u67E5\u770B:id->".concat(id));
      },
      _del: function _del(id) {
        return console.log("\u5220\u9664\uFF1Aid->".concat(id));
      },
      //导出所有事件处理函数

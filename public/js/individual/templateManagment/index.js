...
"use strict";
/*!************************************************************!*\
  !*** ./resources/js/individual/templateManagment/index.ts ***!
  \************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils */ "./resources/js/utils/index.ts");
var __awaiter = undefined && undefined.__awaiter || function (thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function (resolve) {
      resolve(value);
...
var Template = /** @class */function () {
  function Template() {
    this.registerUpload();
    (0,_utils__WEBPACK_IMPORTED_MODULE_0__.registerFunction)(this.oprate());
  }
  Template.prototype.registerUpload = function () {
    var _this = this;
    //注册事件
    ...
    uploadField.addEventListener("change", function (event) {
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          //发送请求
          $.ajax({
            url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.url)("/animated-images"),
            method: "post",
            data: formData,
            headers: {
            ...
            success: function success(res) {
              ...
              if (res.status == "success") {
                $("#renderImage").html(function (index, old) {
  ...
  //定义页面事件
  Template.prototype.oprate = function () {
    return {
      _setupTemplateContent: function _setupTemplateContent(dom) {
        var id = $(dom).attr("loan-template");
        window.location.href = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.url)("/individual/templateManagment/detail/".concat(id));
      }
    };
  };
  return Template;

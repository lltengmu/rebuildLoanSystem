...
var DataTables = /** @class */function () {
  ...
  DataTables.prototype.registerFormValidate = function () {
    var _this = this;
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#individual-create-admin", function (form, event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/individualManagement/add-admin"),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
        },
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#individual-create-admin").serializeArray(),
        success: function success(res) {
          if (res.status == "success") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#create-admin #cancel-modal").click();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#individual-create-admin").find("input").val("");
            _this.tableInstance.ajax.reload();
        ...
        error: function error(_error3) {
          if (_error3.status == 422) {
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#individual-create-admin", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error3.responseJSON.errors));
          }
        }
      });
    });
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#admin-details", function (form, event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/individualManagement/edit-admin/".concat(globalThis["admin_id"])),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
        },
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#admin-details").serializeArray(),
        success: function success(res) {
          if (res.status == "success") {
        ...
        error: function error(_error4) {
          if (_error4.status == 422) {
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#admin-details", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error4.responseJSON.errors));
          }
        }
      });
    });

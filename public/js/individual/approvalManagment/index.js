...
/***/ "./resources/js/individual/approvalManagment/dataTable.ts":
/*!****************************************************************!*\
  !*** ./resources/js/individual/approvalManagment/dataTable.ts ***!
  \****************************************************************/
...
var ApprovalManagmentDataTable = /** @class */function () {
  ...
  ApprovalManagmentDataTable.prototype.registerDataTable = function () {
    this.tableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#caseTable").DataTable({
      ...
      order: [0, "desc"],
      ajax: {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/approvalManagment/cases"),
        method: "post",
        headers: {
  ...
  ApprovalManagmentDataTable.prototype.opration = function () {
    ...
    return {
      ...
      _view: function _view(id) {
        return window.location.href = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/individual/approvalManagment/details/".concat(id));
      },
      //删除功能
...
"use strict";
/*!************************************************************!*\
  !*** ./resources/js/individual/approvalManagment/index.ts ***!
  \************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dataTable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataTable */ "./resources/js/individual/approvalManagment/dataTable.ts");

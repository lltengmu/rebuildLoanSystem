...
var IndividualLogin = /** @class */function () {
  function IndividualLogin(form, captchaImg) {
    this.captchaApiResponse = null;
  ...
  IndividualLogin.prototype.init = function () {
    var _this = this;
    this.captchatImg.addEventListener('click', function () {
      return _this.refreshCaptcha();
    });
    this.loginFormValidate();
  };
  IndividualLogin.prototype.refreshCaptcha = function () {
    this.captchatImg.src = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/captcha?") + Math.random();
  };
  IndividualLogin.prototype.loginFormValidate = function () {
    var _this = this;
    (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#login-form", function (form, event) {
      //组织浏览器默认提交行为
      event.preventDefault();
      //获取当前用户登录身份
      var identify = document.querySelector("input[name=\"_identify\"]").value;
      //获取表单字段
      var data = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#login-form').serializeArray();
      //发送登录请求
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/".concat(identify, "/login")),
        method: "post",
        data: data,
        headers: {
        ...
        success: function success(res) {
          _utils_index__WEBPACK_IMPORTED_MODULE_1__.store.set("token", res.data.token);
          window.location.href = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/".concat(identify, "/home"));
        },
        error: function error(_error) {
          if (_error.status == 422) {
            (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#login-form", (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors));
            if (Object.keys((0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors)).includes("captcha")) _this.refreshCaptcha();
          }
        }
      });
    });

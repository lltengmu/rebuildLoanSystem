...
var IndividualLogin = /** @class */function () {
  ...
  IndividualLogin.prototype.loginFormValidate = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.loginForm).validate({
      rules: {
        'email': {
          required: true
        },
      ...
      submitHandler: function submitHandler(form, event) {
        return __awaiter(_this, void 0, void 0, function () {
          var identify, data, res;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                //组织浏览器默认提交行为
                event.preventDefault();
                identify = document.querySelector("input[name=\"_identify\"]").value;
                data = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#login-form').serializeArray();
              ...
              case 1:
                ...
                if (res.errorsObject && !res.success) {
                  ...
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#login-form").validate().showErrors(res.errorsObject);
                } else location.href = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/".concat(identify, "/home"));
                return [2 /*return*/];
            }
          });
        });

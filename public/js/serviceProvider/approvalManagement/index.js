...
/***/ "./resources/js/plugins/notification/index.ts":
/*!****************************************************!*\
  !*** ./resources/js/plugins/notification/index.ts ***!
  \****************************************************/
...
var notification = new notyf__WEBPACK_IMPORTED_MODULE_0__.Notyf({
  duration: 3000,
  position: {
    x: "right",
    y: "top"
...
/***/ "./resources/js/serviceProvider/approvalManagement/dataTable.ts":
/*!**********************************************************************!*\
  !*** ./resources/js/serviceProvider/approvalManagement/dataTable.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils */ "./resources/js/utils/index.ts");
...
/* harmony import */ var datatables_net__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! datatables.net */ "./node_modules/datatables.net/js/jquery.dataTables.mjs");




var PendingDataTable = /** @class */function () {
  function PendingDataTable() {
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.registerFunction)(this.opration());
    this.registerDataTable();
    this.registerArovalDataTable();
  }
  PendingDataTable.prototype.registerDataTable = function () {
    this.pendingTableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#pending").DataTable({
      autoWidth: true,
      order: [0, "desc"],
      ajax: {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/ApprovalManagement/pending"),
        method: "post",
        headers: {
      ...
      columnDefs: [{
        ...
        render: function render(data, type, row, meta) {
          var id = row.id;
          return "\n                            <div class=\"opration d-flex justify-content-start align-items-center\">\n                                <div class=\"form-group m-0 pr-2\" style=\"width:10vw;\">\n                                    <select class=\"form-control form-control-sm\" id=\"select-case-status-".concat(id, "\" onchange=\"_handleSelect('").concat(id, "')\">\n                                        <option value=\"2\">\u8ACB\u9078\u64C7</option>\n                                        <option value=\"3\">\u540C\u610F</option>\n                                        <option value=\"5\">\u62D2\u7EDD</option>\n                                    </select>\n                                </div>\n                                <button type=\"button\" class=\"btn btn-outline-danger\" data-toggle=\"modal\" data-target=\".delete-modal\" onclick=\"_reject('").concat(id, "')\">\u9A73\u56DE</button>\n                            </div>\n                        ");
        }
      }]
    });
  };
  PendingDataTable.prototype.registerArovalDataTable = function () {
    this.approvalTableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#Approval-Reject").DataTable({
      autoWidth: true,
      order: [0, "desc"],
      ajax: {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/ApprovalManagement/approvalList"),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
        },
      ...
      columnDefs: [{
        ...
        render: function render(data, type, row, meta) {
          var id = row.id;
          return "\n                            <div class=\"opration d-flex justify-content-start align-items-center\" onclick=\"_withdraw('".concat(id, "')\">\n                                <button type=\"button\" class=\"btn btn-outline-secondary\">\u64A4\u56DE\u64CD\u4F5C</button>\n                            </div>\n                        ");
        }
      }]
    });
  };
   ...
   */
  PendingDataTable.prototype.opration = function () {
    var _this = this;
    return {
      _uploadExcel: function _uploadExcel() {
        return jquery__WEBPACK_IMPORTED_MODULE_0___default()("#uploadExcel").click();
      },
      _reject: function _reject(id) {
        var el = document.querySelector("button[class*=\"confirm\"]");
        el.onclick = function () {
          return _this.handleRejectCase(id);
        };
      },
      _handleSelect: function _handleSelect(id) {
        var decide = new Promise(function (resolve, reject) {
          if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#select-case-status-".concat(id)).val() == 3) resolve(id);else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#select-case-status-".concat(id)).val() == 5) reject(id);
        });
        decide.then(
        //handle agree
        function (id) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#approvalbtn").click();
          var el = document.querySelector("#approval #check");
          el.onclick = function (event) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
              url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/ApprovalManagement/approval/".concat(id)),
              method: "PUT",
              data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#approval-form").serializeArray(),
              headers: {
                "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
              },
              success: function success(res) {
                if (res.status == "success") {
                  //关闭模态框
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#approval #cancel").click();
                  //清除模态框数据数据
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#approval-form").find("input,textarea").val("");
                  //显示通知
                  (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(res.message);
                  //重新加载数据表
                  _this.pendingTableInstance.ajax.reload();
                  _this.approvalTableInstance.ajax.reload();
                }
              },
              error: function error(_error) {
                if (_error.status == 422) {
                  (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#approval-form", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors));
                }
              }
            });
          };
        ...
        //handle disagree
        function (id) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refuseBtn").click();
          var el = document.querySelector("#refuse #check");
          el.onclick = function (event) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
              url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/ApprovalManagement/refuse/".concat(id)),
              method: "post",
              data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refuse-form").serializeArray(),
              headers: {
                "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
              },
              success: function success(res) {
                if (res.status == "success") {
                  //关闭模态框
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refuse #cancel").click();
                  //清除模态框数据数据
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#refuse-form").find("textarea").val("");
                  //显示通知
                  (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(res.message);
                  //重新加载数据表
                  _this.pendingTableInstance.ajax.reload();
              ...
              error: function error(_error2) {
                if (_error2.status == 422) {
                  (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#refuse-form", (0,_utils__WEBPACK_IMPORTED_MODULE_1__.parse)(_error2.responseJSON.errors));
                }
              }
            });
          };
      ...
      _withdraw: function _withdraw(id) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
          method: "PUT",
          url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/ApprovalManagement/withdraw/".concat(id)),
          headers: {
            "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
          },
          success: function success(res) {
  ...
  PendingDataTable.prototype.handleRejectCase = function (id) {
    var _this = this;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("button[id=\"cancel\"]").click();
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/ApprovalManagement/reject/".concat(id)),
      method: "PUT",
      headers: {
        "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
      },
      success: function success(res) {
        if (res.status == "success") (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(res.message);
        _this.pendingTableInstance.ajax.reload();
        _this.approvalTableInstance.ajax.reload();
      },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PendingDataTable);
...
var handleError = function handleError(error, callback) {
  if (error.status == 422) {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [2 /*return*/, new Promise(function (resolve, reject) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax(__assign(__assign({}, options), {
          success: function success(res) {
            return resolve(res);
          },
          error: function error(_error) {
            return handleError(_error, resolve);
          }
        }));
      })];
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (Interface) {
  var _a;
  return ((_a = location.href.match(/^(((http:\/\/)|^(https:\/\/)).*index.php)|(http:\/\/127.0.0.1:8000)/ig)) === null || _a === void 0 ? void 0 : _a.join()) + Interface;
});

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./node_modules/notyf/notyf.min.css":
/*!****************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./node_modules/notyf/notyf.min.css ***!
  \****************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_notyf_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!../postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./notyf.min.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[9].oneOf[1].use[2]!./node_modules/notyf/notyf.min.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_notyf_min_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_9_oneOf_1_use_2_notyf_min_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
"use strict";
/*!******************************************************************!*\
  !*** ./resources/js/serviceProvider/approvalManagement/index.ts ***!
  \******************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dataTable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataTable */ "./resources/js/serviceProvider/approvalManagement/dataTable.ts");

...
/***/ "./resources/js/serviceProvider/loanApplication/dataTable.ts":
/*!*******************************************************************!*\
  !*** ./resources/js/serviceProvider/loanApplication/dataTable.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
console.log((0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/loanApplication/cases"));
var LoanApplicationDataTable = /** @class */function () {
  ...
  LoanApplicationDataTable.prototype.registerDataTable = function () {
    this.tableInstance = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#caseTable").DataTable({
      ...
      order: [0, "desc"],
      ajax: {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/home/cases"),
        method: "post",
        headers: {
  ...
  LoanApplicationDataTable.prototype.opration = function () {
    ...
    return {
      _export: function _export(id) {
        return window.location.href = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/home/export/".concat(id));
      },
      _view: function _view(id) {
        return window.location.href = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/home/details/".concat(id));
      },
      ...
      _handleExportAll: function _handleExportAll() {
        return window.location.href = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/home/exportAll");
      },
  ...
  LoanApplicationDataTable.prototype.registerUpload = function () {
    ...
    uploadField.addEventListener("change", function (event) {
      ...
      //发送请求
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/sp/home/uploadExcel"),
        method: "post",
        data: formData,
        headers: {
          "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
...
"use strict";
/*!***************************************************************!*\
  !*** ./resources/js/serviceProvider/loanApplication/index.ts ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dataTable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataTable */ "./resources/js/serviceProvider/loanApplication/dataTable.ts");

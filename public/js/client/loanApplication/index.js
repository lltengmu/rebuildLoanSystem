...
/***/ "./resources/js/client/loanApplication/dataTable.ts":
/*!**********************************************************!*\
  !*** ./resources/js/client/loanApplication/dataTable.ts ***!
  \**********************************************************/
      ...
      _edit: function _edit(id) {
        ...
        var handleSuccess = function handleSuccess(res) {
          ...
          Object.entries(response).forEach(function (_a) {
            var key = _a[0],
              value = _a[1];
            var dom = document.querySelector("div#showdetails #".concat(key));
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
          url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.url)("/clients/home/details/".concat(id)),
          method: "post",
          headers: {
            "X-CSRF-token": document.querySelector("meta[name=\"csrf-token\"]").content
          },
...
"use strict";
/*!******************************************************!*\
  !*** ./resources/js/client/loanApplication/index.ts ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dataTable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataTable */ "./resources/js/client/loanApplication/dataTable.ts");

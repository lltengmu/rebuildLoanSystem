...
var SetupPassword = /** @class */function () {
  ...
  SetupPassword.prototype.formValidate = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.form).validate({
      rules: {
        "password": {
          required: true
        },
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                //组织浏览器默认提交行为
                event.preventDefault();
                data = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#setUpPassword').serializeArray();
                data.push({
                  name: "id",
              ...
              case 1:
                ...
                if (res.errorsObject && !res.success) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#setUpPassword").validate().showErrors(res.errorsObject);
                } else location.href = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/clients/home");
                return [2 /*return*/];
            }
          });
        });

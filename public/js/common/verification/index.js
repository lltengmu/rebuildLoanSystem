...
"use strict";
/*!***************************************************!*\
  !*** ./resources/js/common/verification/index.ts ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
var EmailVerification = /** @class */function () {
  ...
  EmailVerification.prototype.formValidate = function () {
    (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#email-verification", function (form, e) {
      e.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        url: (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/verification/".concat(window.location.href.split('/').reverse()[0])),
        method: "post",
        headers: {
          "X-CSRF-token": document.querySelector("input[name=\"_token\"]").value
        },
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#email-verification").serializeArray(),
        success: function success(res) {
        ...
        error: function error(_error) {
          if (_error.status == 422) {
            (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#email-verification", (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors));
          }
        }
      });
    });

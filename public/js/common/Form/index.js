...
var LoanForm = /** @class */function () {
  ...
  LoanForm.prototype.loginFormValidate = function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#register").validate({
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                if (res.errorsObject && !res.success) {
                  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#register").validate().showErrors(res.errorsObject);

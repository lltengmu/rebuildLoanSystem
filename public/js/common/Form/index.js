...
/***/ "./resources/js/common/Form/validate.ts":
/*!**********************************************!*\
  !*** ./resources/js/common/Form/validate.ts ***!
  \**********************************************/
...
/* harmony import */ var _utils_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/index */ "./resources/js/utils/index.ts");
...
//定义业务逻辑类
var LoanForm = /** @class */function () {
  function LoanForm() {
    this.loginFormValidate();
  }
  LoanForm.prototype.loginFormValidate = function () {
    (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.registerFormValidation)("#register", function (form, e) {
      e.preventDefault();
      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()("#agree").prop("checked")) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
        ...
        url: (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/new-loanApplication"),
        method: "post",
        data: jquery__WEBPACK_IMPORTED_MODULE_0___default()('#register').serializeArray(),
        success: function success(res) {
          if (res.status == "success") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#register").find("input textarea").val("");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#register").find("select").val(0);
            (0,_plugins_notification__WEBPACK_IMPORTED_MODULE_2__["default"])(res.message);
            setTimeout(function () {
              return window.location.href = (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.url)("/clients/login");
            }, 2000);
          }
        },
        error: function error(_error) {
          if (_error.status == 422) {
            (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.showErrors)("#register", (0,_utils_index__WEBPACK_IMPORTED_MODULE_1__.parse)(_error.responseJSON.errors));
          }
        }
      });
    });
...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/common/Form/index.ts ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate */ "./resources/js/common/Form/validate.ts");

window.onload = function () {
  return new _validate__WEBPACK_IMPORTED_MODULE_0__["default"]();
};
})();

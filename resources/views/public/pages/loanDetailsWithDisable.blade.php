                                            ...
                                            <div class="col-lg-12 p-0">
                                                ...
                                                <section class="alert-light text-left p-2">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input type="text" disabled class="form-control" id="loan_amount" name="loan_amount" value="{{ $data['loan_amount'] }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input type="text" disabled class="form-control" id="repayment_period" name="repayment_period" value="{{ $data['repayment_period'] }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" rows="4" id="case_remark" name="case_remark">{{ $data['case_remark'] }}</textarea>
                                                        </div>
                                                    </div>
                                                </section>
                                            </div>

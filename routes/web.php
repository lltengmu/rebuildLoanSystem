...
use App\Http\Controllers\Resources\LoanTemplateController;
...
//客户设置密码
Route::match(["get", "post"], "/verification/{id}", Verification::class);
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('loan-template', LoanTemplateController::class);
    ...
    Route::middleware('individual')->prefix('/individual')->group(function () {
        ...
        Route::prefix("/templateManagment")->group(function () {
            ...
            Route::get("/detail/{id}", [TemplateManagement::class, "detail"]);
            Route::post("/edit/{id}", [TemplateManagement::class, "edit"]);
        });
        //定义客户管理页面路由
